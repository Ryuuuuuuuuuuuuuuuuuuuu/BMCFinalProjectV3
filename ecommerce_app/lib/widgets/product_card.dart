...
class ProductCard extends StatelessWidget {
  ...
  // 4. The constructor takes this data
  const ProductCard({
    super.key,
    required this.productName,
    required this.price,
    required this.imageUrl,
    required this.onTap, // ✅ added to constructor
  });

  @override
  Widget build(BuildContext context) {
    // ✅ Wrap the Card in an InkWell so it becomes tappable
    return InkWell(
      onTap: onTap, // ✅ this calls the function passed in when tapped
      child: Card(
        elevation: 3,
        child: Column(
